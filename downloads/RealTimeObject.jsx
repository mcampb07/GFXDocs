...
var null_1 = __webpack_require__(8);
var scroll_1 = __webpack_require__(9);
var shape_1 = __webpack_require__(10);
var text_1 = __webpack_require__(11);
var time_1 = __webpack_require__(12);
var trackmatte_1 = __webpack_require__(13);
var transformation_1 = __webpack_require__(14);
var util_1 = __webpack_require__(4);
var xmp_1 = __webpack_require__(5);
...
var NullInfo = /** @class */ (function () {
    ...
    NullInfo.prototype.hasData = function () {
        return this.layer instanceof AVLayer &&
...
var ShapeInfo = /** @class */ (function () {
    ...
    ShapeInfo.prototype.hasShapeFill = function () {
...
var Transformation = /** @class */ (function () {
    function Transformation(index, anchorPoint, sourceRect, position, scale, opacity, rotation, blurValue, blurDims, blurRE, mask, roundness, XRotation, YRotation) {
        this.index = index;
...
function generateTransformations(layer) {
    ...
    util_1.undoExec("Get Transformation Info", function () {
        ...
        var properties = [
            { accessor: layer.anchorPoint, name: "transform.anchorPoint" },
            { accessor: layer.position, name: "transform.position" },
            { accessor: layer.scale, name: "transform.scale" },
            { accessor: layer.opacity, name: "transform.opacity" },
        ];
        ...
        for (var i = 1; i <= numKeys; i++) {
            var time = layer.position.keyTime(i);
            var transformation = new Transformation(i - 1 + indexOffset, layer.anchorPoint.keyValue(i), layer.sourceRectAtTime(time, false), layer.position.keyValue(i), layer.scale.keyValue(i), layer.opacity.keyValue(i), layer.threeDLayer === true ? getRotation(time, "Z") : layer.rotation.keyValue(i), getBlurValue("Blurriness", time), getBlurValue("Blur Dimensions", time), getBlurValue("Repeat Edge Pixels", time), getMask(time), getRoundness(time), getRotation(time, "X"), getRotation(time, "Y"));
